 ...
 */
public class InventLocal extends Fragment {
    ...
    public static InventLocal newInstance(String param1, String param2) {
        InventLocal fragment = new InventLocal();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_invent_local, container, false);
    ...
    public void sincronizar() {
        Toast.makeText(getContext(), "Cargando productos de la BD Local", Toast.LENGTH_LONG).show();
