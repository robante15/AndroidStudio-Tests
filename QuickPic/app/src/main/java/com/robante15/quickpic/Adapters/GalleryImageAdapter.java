package com.robante15.quickpic.Adapters;
...
public class GalleryImageAdapter extends RecyclerView.Adapter<GalleryImageAdapter.ImageViewHolder> {
    ...
    Context context;
    String[] urlList;
    IRecyclerViewClicListener clicListener;

    public GalleryImageAdapter(Context context, String[] urlList, IRecyclerViewClicListener clicListener){
    ...
    public class ImageViewHolder extends  RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            clicListener.onClic(v,getAdapterPosition());
        }
    }
